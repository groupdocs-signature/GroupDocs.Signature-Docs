...
This class implements newly added interface **[IResult](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain/IResult)** that specifies succeeded and failed signatures after process.
...
*   for **Sign** process this is a list of newly created signatures (see **[SignResult](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain/SignResult)**),
*   for **Update** method this property keeps a list of successfully updated signatures (see **[UpdateResult](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain/UpdateResult)**),
*   for **Delete** method this property keeps a list of successfully deleted signatures (see **[DeleteResult](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain/DeleteResult)**)
...
*   signature was passed only with property** SignatureId** identifier (see changes of **[BaseSignature](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain.signatures/BaseSignature)**) that was not found at document signature information layer;
...
This property indicates whether signatures that were marked as **IsSignature = true** should be hidden from document preview or not**. **For more information see **[BaseSignature](https://reference.groupdocs.com/signature/java/com.groupdocs.signature.domain.signatures/BaseSignature).**
